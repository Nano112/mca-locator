				...
				dataZoom: [
					{
						...
						yAxisIndex: 0,
						filterMode: "none",
						zoomOnMouseWheel: true, // Enables zooming with the mouse wheel
						moveOnMouseWheel: true, // Enables panning with the mouse wheel
						moveOnMouseMove: true, // Enables panning with mouse movement
					},
					{
						type: "inside",
						xAxisIndex: 0,
						yAxisIndex: 0,
						filterMode: "none",
						zoomOnMouseWheel: true, // Ensures synchronized zoom on the y-axis
						moveOnMouseWheel: true, // Ensures synchronized panning on the y-axis
						moveOnMouseMove: true, // Ensures synchronized panning with mouse movement
					},
				],
				grid: {
					containLabel: true,
